...
export const bloomMeta: Record<BloomLevel, { label: string; description: string; color: string; badge: string }> = {
  1: {
    label: "Уровень 1 · Вспоминаем",
    description: "Вспомни факты и события из сказки",
    color: "text-sky-300",
    badge: "border-sky-400/40 bg-sky-400/10 text-sky-300",
  },
  2: {
    label: "Уровень 2 · Разбираемся",
    description: "Объясни, почему герои поступают именно так",
    color: "text-violet-300",
    badge: "border-violet-400/40 bg-violet-400/10 text-violet-300",
  },
  3: {
    label: "Уровень 3 · Думаем глубже",
    description: "Используй знания сказки, чтобы решить сложные задачи",
...
export const quests: Quest[] = [
  // ─── УРОВЕНЬ 1: ЗНАНИЕ ───────────────────────────────────────────
  {
    ...
    bloomLevel: 1,
    title: "Три сестрицы",
    chapter: "Уровень 1 · Вспоминаем",
    instruction: "Вспомни факты из начала сказки и выбери правильный ответ.",
    task: {
      type: "choice",
  ...
  },
  {
    ...
    chapter: "Уровень 1 · Вспоминаем",
    instruction: "Вспомни, какие три чуда были на острове Буяне. Расставь карточки в правильном порядке.",
    task: {
      type: "drag-drop",
  ...
  // ─── УРОВЕНЬ 2: ПОНИМАНИЕ ─────────────────────────────────────────
  {
    ...
    chapter: "Уровень 2 · Разбираемся",
    instruction: "Подумай, почему завистницы подменили письмо царю, и выбери правильный ответ.",
    task: {
      type: "choice",
  ...
  },
  {
    ...
    chapter: "Уровень 2 · Разбираемся",
    instruction: "Восстанови цепочку событий — что за чем следует и почему.",
    task: {
      type: "drag-drop",
  ...
  // ─── УРОВЕНЬ 3: ПРИМЕНЕНИЕ ────────────────────────────────────────
  {
    ...
    bloomLevel: 3,
    title: "Узнай героя",
    chapter: "Уровень 3 · Думаем глубже",
    instruction: "Прочитай описание и определи, о ком идёт речь, — без подсказки в виде имени.",
    task: {
      type: "choice",
  ...
  },
  {
    ...
    chapter: "Уровень 3 · Думаем глубже",
    instruction: "Представь, как могли бы развиваться события сказки, и выбери наиболее подходящий ответ.",
    task: {
      type: "choice",
  ...
  },
  {
    ...
    title: "Главная мысль",
    chapter: "Уровень 3 · Думаем глубже",
    instruction: "Последнее задание — самое глубокое. Отметь все главные мысли, которые Пушкин вложил в сказку.",
    task: {
      type: "find-word",
